...
export type FileFieldsEnum = 
  ...
  'childMarkdownRemark___frontmatter___plan' |
...
export type SideBarQuery = { allMarkdownRemark: { nodes: Array<(
      Pick<MarkdownRemark, 'html' | 'id'>
      & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'className'>> }
    )> } };
...
export type HowToUseQuery = { markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'html' | 'id' | 'excerpt'>
...
export type IndexQuery = { markdownRemark: Maybe<(
    ...
    & { frontmatter: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'heading' | 'subheading' | 'callToAction' | 'callToActionURL' | 'callToActionSmallText'>
      & { backgroundImage: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }
    )> }
  )>, allMarkdownRemark: { nodes: Array<(
      Pick<MarkdownRemark, 'html' | 'id'>
      & { frontmatter: Maybe<(
        Pick<MarkdownRemarkFrontmatter, 'align' | 'className' | 'imageColumnWidth'>
        & { rightImage: Maybe<(
...
export type SubscriptionQuery = { allMarkdownRemark: { nodes: Array<(
      Pick<MarkdownRemark, 'html' | 'id'>
      & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'plan'>> }
    )> } };
...
export type SlideShowQueryVariables = {};


export type SlideShowQuery = { allMarkdownRemark: { nodes: Array<(
      Pick<MarkdownRemark, 'html' | 'id'>
      & { frontmatter: Maybe<{ image: Maybe<Pick<File, 'publicURL'>> }> }
    )> } };
