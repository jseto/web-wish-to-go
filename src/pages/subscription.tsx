...
export class Subscription extends React.Component<SubscriptionProps, SubscriptionState> {
	...
	render() {
		...
		return (
			<Layout>
				<SEO title={ `Sign-up to ${ this.plan } plan` } description={`Subscribe to ${ this.plan } plan`}/>
				...
				<SectionBody>
					...
					{ content &&
						<MarkdownBlock className="small-img" content={ content.html } contentColumnWidth={8}/>
					}
